...
#define UE_PROJECT_NAME CI_CD_Inv_Game
#define UE_TARGET_NAME CI_CD_Inv_GameEditor
#define UE_MODULE_NAME "CI_CD_Inv_Game"
...
#define CI_CD_INV_GAME_API DLLEXPORT
